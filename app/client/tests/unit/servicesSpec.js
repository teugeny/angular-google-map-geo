  ...
  describe('Auth', function() {
    describe('instantiate', function() {
      ...
      it('should set the user object with no name and public role', function() {
        expect(Auth.user).to.deep.equal({ email: '', role: Auth.userRoles.public });
      });
    });
    ...
    describe('register', function() {
      ...
      it('should append the user', function() {
        ...
        Auth.register({}, success, error);
        $httpBackend.flush();
        expect(Auth.user).to.deep.equal({ email : '', role : { bitMask : 1, title : 'public' }, user : 'foo' });
      });
    });
    ...
    describe('login', function() {
      ...
      it('should append the user', function() {
        ...
        Auth.login({}, success, error);
        $httpBackend.flush();
        expect(Auth.user).to.deep.equal({ email : '', role : { bitMask : 1, title : 'public' }, user : 'bar' });
      });
    });
